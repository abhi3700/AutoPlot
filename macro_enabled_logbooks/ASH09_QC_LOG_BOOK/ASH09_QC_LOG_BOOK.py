...
def draw_asfe1_cp_plot(plot_sht, x, y0, y1, y2):
    ...
    plt.plot(x, y0, linestyle='-', marker='o', markerfacecolor='#008000', color='#FF7F50')    # plot date vs CP
    plt.plot(x, y1, linestyle='-', color='#0000CD')        # plot date vs USL
    plt.plot(x, y2, linestyle='-', color='#FF1493')        # plot date vs UCL
    ...
    plot_sht.pictures.add(fig_asfe1_cp, name= "ASFE1_CP_Plot", update= True)
...
def draw_asfe1_er_plot(plot_sht, x, y0, y1, y2, y3):
    ...
    plt.plot(x, y0, linestyle='-', marker='o', markerfacecolor='#008000', color='#FF7F50')    # plot date vs ER
    plt.plot(x, y1, linestyle='-', color='#FF1493')        # plot date vs UCL
    plt.plot(x, y2, linestyle='-', color='#0000CD')        # plot date vs LSL
    plt.plot(x, y3, linestyle='-', color='#FF1493')        # plot date vs LCL 
    plt.xlabel('Date', fontsize=18)      # xlabel
    ...
    plot_sht.pictures.add(fig_asfe1_er, name= "ASFE1_ER_Plot", update= True)
...
def draw_asfe1_unif_plot(plot_sht, x, y0, y1):
    ...
    plt.plot(x, y0, linestyle='-', marker='o', markerfacecolor='#008000', color='#FF7F50')    # plot date vs Unif (in %)
    plt.plot(x, y1, linestyle='-', color='#FF1493')        # plot date vs Unif UCL (in %)
    plt.xlabel('Date', fontsize=18)      # xlabel
    ...
    # plt.show()        # shows 2 figures in different windows
    plot_sht.pictures.add(fig_asfe1_unif, name= "ASFE1_Unif_Plot", update= True)
