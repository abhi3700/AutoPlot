...
def main():
    ...
    df_reox1c_cp = sht_reox1c_cp.range('A9').options(
        ...
        ).value                                                         # fetch the data from sheet- 'REOX1C-CP'
    ...
    df_reox1c_er = excel_file_sht_er.parse('REOX1C-ER', skiprows=13)                            # copy a sheet and paste into another sheet and skiprows 8
