...
def main():
    ...
    df_cp = sht_repl1b_cp.range('A9').options(
    ...
    sht_cp_plot.pictures.add(fig_cp, name= "REPL1B_CP_Plot", update= True)
    ...
    _ = plt.xticks(rotation=90)                                         # rotating 90 counterclockwise
    # ax_er_nit.xaxis.set_major_locator(mdates.MonthLocator(interval=1))         # set ticks after every 2 Mondays
    ...
    sht_plot_nit.pictures.add(fig_er_nit, name= "REPL1B_NIT_ER_Plot", update= True)
    ...
    # plt.show()        # shows 2 figures in different windows
    sht_plot_nit.pictures.add(fig_unif_nit, name= "REPL1B_NIT_UNIF_Plot", update= True)
    ...
    ax_er_poly.xaxis.set_major_locator(mdates.WeekdayLocator(byweekday=MO, interval=1))          # set ticks after every 2 Mondays
    ...
    # plt.show()        # shows 2 figures in different windows
    sht_plot_poly.pictures.add(fig_er_poly, name= "REPL1B_POLY_ER_Plot", update= True)
    ...
    ax_unif_poly.legend(custom_lines_unif_poly, ['Unif', 'USL', 'UCL'], fontsize=11, loc='upper right') 
    ...
    # plt.show()        # shows 2 figures in different windows
    sht_plot_poly.pictures.add(fig_unif_poly, name= "REPL1B_POLY_UNIF_Plot", update= True)
