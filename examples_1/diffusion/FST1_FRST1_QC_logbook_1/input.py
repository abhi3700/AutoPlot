...
unif_plot_trace1_mode_top = 'lines+markers'    # Chart mode for Top uniformity -> 'lines+markers' or 'lines' or 'markers'
unif_plot_trace2_mode_cnt = 'lines+markers'    # Chart mode for Center uniformity -> 'lines+markers' or 'lines' or 'markers'
unif_plot_trace3_mode_btm = 'lines+markers'    # Chart mode for BTM uniformity -> 'lines+markers' or 'lines' or 'markers'
...
cp_plot_trace1_mode_top = 'lines+markers'    # Chart mode for Top CP -> 'lines+markers' or 'lines' or 'markers'
cp_plot_trace2_mode_cnt = 'lines+markers'    # Chart mode for Center CP -> 'lines+markers' or 'lines' or 'markers'
cp_plot_trace3_mode_btm = 'lines+markers'    # Chart mode for BTM CP -> 'lines+markers' or 'lines' or 'markers'
