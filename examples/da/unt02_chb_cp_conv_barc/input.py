...
er_barc_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_barc_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_pr_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_pr_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_teos_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_teos_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_sin_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_sin_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
sht_cp_columns = ["Date (MM/DD/YYYY)", "CP type", "Delta CP 0.16u", "Delta CP 0.5u", "Delta CP AC", "USL", "UCL", "Remarks"]
