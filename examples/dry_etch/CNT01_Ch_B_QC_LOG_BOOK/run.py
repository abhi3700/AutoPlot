...
def main():
    ...
    df_repl1b_cp = excel_file.parse(sht_name_cp, skiprows=8)                            # copy a sheet and paste into another sheet and skiprows 9    
    ...
    df_repl1b_er_nit = excel_file.parse(sht_name_er_nit, skiprows=9)                            # copy a sheet and paste into another sheet and skiprows 9    
    ...
    df_repl1b_er_poly = excel_file.parse(sht_name_er_poly, skiprows=9)                            # copy a sheet and paste into another sheet and skiprows 9    
