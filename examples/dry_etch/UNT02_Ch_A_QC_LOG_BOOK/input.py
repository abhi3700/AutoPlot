...
er_sin_1st_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_sin_1st_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_sin_2nd_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_sin_2nd_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_teos_1st_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_teos_1st_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
...
er_teos_2nd_plot_xlabel = 'Date (DD/MM/YYYY)'        # xaxis name for ER plot
...
unif_teos_2nd_plot_xlabel = 'Date (DD/MM/YYYY)'      # xaxis name for Unif plot
