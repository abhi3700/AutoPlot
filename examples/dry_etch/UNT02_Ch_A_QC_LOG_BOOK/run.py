...
def draw_plotly_resp1a_er_sin_1st_plot(x, y1, y2, y3, y4, y5, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= er_sin_1st_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_unif_sin_1st_plot(x, y1, y2, y3, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= unif_sin_1st_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_er_sin_2nd_plot(x, y1, y2, y3, y4, y5, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= er_sin_2nd_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_unif_sin_2nd_plot(x, y1, y2, y3, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= unif_sin_2nd_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_er_teos_1st_plot(x, y1, y2, y3, y4, y5, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= er_teos_1st_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_unif_teos_1st_plot(x, y1, y2, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= unif_teos_1st_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_er_teos_2nd_plot(x, y1, y2, y3, y4, y5, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= er_teos_2nd_plot_html_file, auto_open= auto_open)
...
def draw_plotly_resp1a_unif_teos_2nd_plot(x, y1, y2, remarks):
    ...
    fig = dict(data= data, layout= layout)
    py.offline.plot(fig, filename= unif_teos_2nd_plot_html_file, auto_open= auto_open)
...
def main():
    ...
    df_resp1a_cp = excel_file.parse(sht_name_cp, skiprows=8)                            # copy a sheet and paste into another sheet and skiprows 9
