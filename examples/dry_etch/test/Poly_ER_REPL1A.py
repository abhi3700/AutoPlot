...
# ----------------------------------------------------------------------
# input vars for REPL1B
# filename_pre = 'Al_PRE_Contour_plot_XRA_'
filename_er = 'Poly_ER_Contour_plot_REPL1B_'
# titlename_pre = 'PRE-Thickness'
titlename_er = 'ER'

excel_file_directory = 'cnt01b.xlsx'
cols = ['site_1', 'site_2', 'site_3', 'site_4', 'site_5', 'site_6', 'site_7',
        'site_8', 'site_9', 'site_10', 'site_11', 'site_12', 'site_13', 'site_14', 
        'site_15', 'site_16', 'site_17']
        
sht_name = 'poly'
skiprows_ = 10
coords_x = [0, 0, 0, 0, 0, 0, 0, 0, 0, -90, -67.5, -45, -22.5, 22.5, 45, 67.5, 90]
coords_y = [90, 67.5, 45, 22.5, 0, -22.5, -45, -67.5, -90, 0, 0, 0, 0, 0, 0, 0, 0]


# row_list_pre = [0, 3, 6, 9, 12]
row_list_er = [2, 5, 8, 11, 14, 17]
...
def contour_plot(i, l, fname, tname):
    ...
    layout = dict(
                title = 'Poly ' + tname + ' Contour plot on REPL1B for ' + 'RUN ' + str(l.index(i)+1),
                xaxis = dict(
                            title= 'x-axis (in mm)',
                            # type='linear',
                            range= [-100, 100]
