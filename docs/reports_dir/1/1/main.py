...
file_directory = 'Average Products Lot yield Aeff only 2020.xlsx'
...
df = pd.read_excel(file_directory, sheet_name= "Average Products yield Aeff onl", skiprows= 0)
# print(df)
cols = ["Aeff (mm2)", "Device_ID", "Device_Name", "LotID", "Lot Yield (%)"]

# print(df[cols[4]].min())            # max
# print(df[cols[4]].max())            # max
